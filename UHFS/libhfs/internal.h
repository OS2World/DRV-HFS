...
#ifdef UHFS
# define ALLOC(type, n)		((type *) os2_malloc(SIZE(type, n)))
# define ALLOCX(type, n)	((n) ? ALLOC(type, n) : (type *) 0)
# define FREE(ptr)		((ptr) ? (void) os2_free((void *) ptr) : (void) 0)
# define REALLOC(ptr, type, n)  \
    ((type *) ((ptr) ? os2_realloc(ptr, SIZE(type, n)) : os2_malloc(SIZE(type, n))))
#else
...
struct _hfsvol_ {
  unsigned int fd;	/* volume's open file descriptor */ /*MB*/
  int flags;		/* bit flags */
